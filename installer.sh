...
TMP_PATH=/tmp
IFACE=eth0
APT='python-dev avahi-daemon cups python-cups printer-driver-gutenprint system-config-printer-udev python-pip cups-pdf pip install git python-daemon ink samba preload logrotate'
